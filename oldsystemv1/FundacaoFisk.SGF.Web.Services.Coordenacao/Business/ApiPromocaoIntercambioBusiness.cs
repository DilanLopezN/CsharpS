...
{
    public class ApiPromocaoIntercambioBusiness: IApiPromocaoIntercambioBusiness
    {

        public ITurmaDataAccess TurmaDataAccess { get; set; }
        private IEmpresaDataAccess EmpresaDataAccess { get; set; }

        public ApiPromocaoIntercambioBusiness(ITurmaDataAccess turmaDataAccess, IEmpresaDataAccess empresaDataAccess)
        {
        ...
        public string postExecutaRequestPromocaoIntercambio(PromocaoIntercambioParams parametros)
        {
            ...
            if (String.IsNullOrEmpty(url))
            {
                ...
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgUrlPromocaoIntercambioNuloVazio, url, parametrosMsgError.ToString()), null, ApiPromocaoIntercambioException.TipoErro.URL_NULO_VAZIO, false);
            }
            ...
            if (String.IsNullOrEmpty(bearerToken))
            {
                ...
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgBearerPromocaoIntercambioNuloVazio, url, parametrosMsgError.ToString()), null, ApiPromocaoIntercambioException.TipoErro.BEARER_NULO_VAZIO, false);
            }
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                {
                    throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErrorRequestApiPromocaoIntercambio, objResponseContent.error, objResponseContent.error_description, url, parametrosMsgError.ToString()), null, ApiPromocaoIntercambioException.TipoErro.ERROR_REQUEST, false);
            ...
            else
            {
                ...
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroStatusCodeRequestApiPromocaoIntercambio, "IsSuccessStatusCode -> false", url, parametros), null, ApiPromocaoIntercambioException.TipoErro.ERROR_REQUEST, false);
            }
        ...
        public void ValidaParametros(PromocaoIntercambioParams parametros)
        {
            ...
            if (parametros == null)
            {
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroApiPromocaoIntercambioParametros, "Parametros Nulos"), null, ApiPromocaoIntercambioException.TipoErro.ERRO_PARAMETROS, false);
            }

            if (String.IsNullOrEmpty(parametros.cpf))
            {
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroApiPromocaoIntercambioParametros, "CPF Nulo ou Vazio"), null, ApiPromocaoIntercambioException.TipoErro.ERRO_PARAMETROS, false);
            }

           
            if (String.IsNullOrEmpty(parametros.email))
            {
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroApiPromocaoIntercambioParametros, "EMAIL Nulo ou Vazio"), null, ApiPromocaoIntercambioException.TipoErro.ERRO_PARAMETROS, false);
            }
            ...
            {
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroApiPromocaoIntercambioParametros, "TIPO Nulo ou Vazio"), null, ApiPromocaoIntercambioException.TipoErro.ERRO_PARAMETROS, false);
            }

            //Valida Unidade
            if (String.IsNullOrEmpty(parametros.unidade))
            {
                throw new ApiPromocaoIntercambioException(string.Format(Utils.Messages.Messages.msgErroApiPromocaoIntercambioParametros, "UNIDADE Nulo ou Vazio"), null, ApiPromocaoIntercambioException.TipoErro.ERRO_PARAMETROS, false);
            }
