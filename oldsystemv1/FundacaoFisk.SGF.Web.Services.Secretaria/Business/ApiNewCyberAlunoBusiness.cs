...
{
    public class ApiNewCyberAlunoBusiness : IApiNewCyberAlunoBusiness
    {
        ...
        public ApiNewCyberAlunoBusiness()
        {
        }
        ...
        public string postExecutaCyber(string url, string comando, string chave, string parametros)
        {
            ...
            foreach (var parametro in parametrosArray)
            {
                ...
                {
                    throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroParametrosExecutaCyber, url, comando, parametros), null, ApiNewCyberAlunoException.TipoErro.ERRO_PARAMETROS_EXECUTA_CYBER, false);
                }
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroComandoExecutaCyber, url, comando, parametros), null, ApiNewCyberAlunoException.TipoErro.ERRO_COMANDO_EXECUTA_CYBER, false);
            }
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroChaveExecutaCyber, url, comando, parametros), null, ApiNewCyberAlunoException.TipoErro.ERRO_CHAVE_EXECUTA_CYBER, false);
            }
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (!String.IsNullOrEmpty(resposta_cyber) && !resposta_cyber.Equals("OK"))
                {
                    ...
                    throw new ApiNewCyberAlunoException(string.Format("Erro Api Cyber -> " + resposta_cyber + "(statusErro: Erro Api newCyber - Url {0} - Comando: {1} - Parametros - {2})", url, comando, parametros), null, ApiNewCyberAlunoException.TipoErro.ERRO_SEND_EXECUTA_CYBER, false);
                }
                else if (String.IsNullOrEmpty(resposta_cyber))
                {
                    throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroSendExecutaCyber, url, comando, parametros), null, ApiNewCyberAlunoException.TipoErro.ERRO_SEND_EXECUTA_CYBER, false);
                }
        ...
        public bool verificaRegistro(string url, string comando, string chave, int codigo)
        {
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroComandoExecutaCyber, url, comando, codigo), null, ApiNewCyberAlunoException.TipoErro.ERRO_COMANDO_EXECUTA_CYBER, false);
            }
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroChaveExecutaCyber, url, comando, codigo), null, ApiNewCyberAlunoException.TipoErro.ERRO_CHAVE_EXECUTA_CYBER, false);
            }
        ...
        public bool verificaRegistroGrupos(string url, string comando, string chave, int codigo_unidade, int codigo_grupo)
        {
            //Se 0 no webConfig não aplica o cyber
            if (!aplicaApiCyber()) return false;
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroComandoExecutaCyber, url, comando, codigo_unidade), null, ApiNewCyberAlunoException.TipoErro.ERRO_COMANDO_EXECUTA_CYBER, false);
            }
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroChaveExecutaCyber, url, comando, codigo_unidade), null, ApiNewCyberAlunoException.TipoErro.ERRO_CHAVE_EXECUTA_CYBER, false);
            }

            //faz a requisição
            var response = httpClient.GetAsync(url + String.Format("?comando={0}&chave={1}&codigo_unidade={2}&codigo_grupo={3}", comando, chave, codigo_unidade, codigo_grupo)).GetAwaiter().GetResult();
            if (response.IsSuccessStatusCode)
            {
                Console.WriteLine("Request Message Information:- \n\n" + response.RequestMessage + "\n");
                Console.WriteLine("Response Message Header \n\n" + response.Content.Headers + "\n");
        ...
        public bool verificaRegistroLivroAlunos(string url, string comando, string chave, int codigo_aluno, int codigo_grupo, int codigo_livro)
        {
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroComandoExecutaCyber, url, comando, codigo_aluno), null, ApiNewCyberAlunoException.TipoErro.ERRO_COMANDO_EXECUTA_CYBER, false);
            }
            ...
            {
                throw new ApiNewCyberAlunoException(string.Format(Utils.Messages.Messages.ErroChaveExecutaCyber, url, comando, codigo_aluno), null, ApiNewCyberAlunoException.TipoErro.ERRO_CHAVE_EXECUTA_CYBER, false);
            }
