...
function mostraMenusFilhos(data, pSubMenu, MenuItem, DropDownMenu, MenuSeparator, id_empresa_propria) {
    if (hasValue(data))
        for (var j = 0; j < data.length; j++) {
            ...
            if ((jQuery.parseJSON(MasterGeral()) && (!id_empresa_propria || (id_empresa_propria && data[j].no_menu != "Faturamento"))) ||
                (!jQuery.parseJSON(MasterGeral()) && data[j].no_menu != "Grupo Master" && (!id_empresa_propria || (id_empresa_propria && data[j].no_menu != "Faturamento")))) {
