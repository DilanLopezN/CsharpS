...
define([
	...
	function handleResponse(response, error){
	    ...
	    /* Eduardo Chagas de Oliveira : alteração do dojo para receber o timeout da aplicação via JsonRest e atualizar o relógio do sistema: */
		var timeoutSession = response.getHeader("timeoutSession");

		if (hasValue(timeoutSession))
		    iniciaRelogio(timeoutSession);
