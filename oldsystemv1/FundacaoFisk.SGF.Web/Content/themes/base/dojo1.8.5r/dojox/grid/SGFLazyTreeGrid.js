...
define("dojox/grid/SGFLazyTreeGrid", ["dojo/_base/kernel", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/event", "dojo/_base/array", "dojo/query", "dojo/parser", "dojo/dom-construct", "dojo/dom-class", "dojo/dom-style", "dojo/dom-geometry", "dojo/dom", "dojo/keys", "dojo/text!./resources/Expando.html", "dijit/_Widget", "dijit/_TemplatedMixin", "./TreeGrid", "./_Builder", "./_View", "./_Layout", "./cells/tree", "./_RowManager", "./_FocusManager", "./_EditManager", "./DataSelection", "./util"], function (_1, _2, _3, _4, _5, _6, _7, _8, _9, _a, _b, _c, _d, _e, _f, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _1a) {
    ...
    var _24 = _2("dojox.grid._TreeGridContentBuilder", _12._ContentBuilder, {
        generateHtml: function (_25, _26) {
            ...
            for (; row = _29[j]; j++) {
                ...
                if (_2c === "dojoxGridNoChildren") {

                    var htmlContent = "<div><textarea readonly id='dc_faq_resposta' name='dc_faq_resposta' data-dojo-type='dijit/form/SimpleTextarea' rows='6' cols='50' style='width: 98% !important;margin-top: 4px;margin-left: 6px;'>" + _2a.dc_faq_resposta + "</textarea></div><br><br>";
                    if (hasValue(_2a.no_video_faq)) {
                        htmlContent = "<div><textarea readonly id='dc_faq_resposta' name='dc_faq_resposta' data-dojo-type='dijit/form/SimpleTextarea' rows='6' cols='50' style='width: 98% !important;margin-top: 4px;margin-left: 6px;'>" + _2a.dc_faq_resposta + "</textarea>" +
                        "<h4 style='margin-left: 4px; margin:auto; font-size: 13px;padding-left: 6px;'>Passo-a-Passo " +
                        "<span class='dijit dijitReset dijitInline dijitButton' role='presentation'>" +
                        "<span onclick='videDetail(\"" + _2a.id + "\")' class='dijitReset dijitInline dijitButtonNode'  role='presentation' style='min-width: 20px; width: 20px;'>" +
                        "<span class='dijitReset dijitStretch dijitButtonContents'  role='button' aria-labelledby='vd_14_label' tabindex='0' id='vd_14' aria-disabled='false' style='user-select: none;'>" +
                        "<span class='dijitReset dijitInline dijitIcon dijitEditorIcon dijitEditorIconPlaySGF' data-dojo-attach-point='iconNode'></span><span class='dijitReset dijitToggleButtonIconChar'>●" +
                        "</span><span class='dijitReset dijitInline dijitButtonText' id='vd_14_label' data-dojo-attach-point='containerNode'></span></span></span>" +
                        "<input type='button' value='' class='dijitOffScreen'  tabindex='-1' role='presentation' data-dojo-attach-point='valueNode'></span></h4></div><br><br>";
                    }

                    _27.push(htmlContent);
                }
                else {
    ...
    _2("dojox.grid._TreeGridView", _13, {
        _contentBuilderClass: _24, postCreate: function () {
    ...
    var _46 = _3.mixin(_3.clone(_15), {
        formatAtLevel: function (_47, _48, _49) {
            if (!_47) {
    ...
    var _50 = _2("dojox.grid._LazyTreeLayout", _14, {
        setStructure: function (_51) {
    ...
    var _54 = _2("dojox.grid._LazyTreeGridCache", null, {
    ...
    var _5b = _2("dojox.grid.LazyTreeGrid", _11, {
        _layoutClass: _50, _size: 0, treeModel: null, defaultState: null, colSpans: null, postCreate: function () {
            this._setState();
            this.inherited(arguments);
            if (!this._treeCache) {
            ...
            if (req.treePath.length === 0) {
                ...
                if (this._by_idty[_88]) {
                    ...
                    this.store.fetchItemByIdentity({
                        identity: _88, onItem: function (_8d) {
