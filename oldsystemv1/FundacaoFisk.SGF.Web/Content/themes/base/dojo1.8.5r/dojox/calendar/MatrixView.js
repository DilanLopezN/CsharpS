		...
		_buildGrid: function (renderData, oldRenderData){
			...
			query("tr", table).forEach(function (tr, row){
				...
				query("td", tr).forEach(function (td, col){
                    ...
                    //Eduardo Chagas - Modificando o dojo para mostrar datas da semana em português:
					td.style.textAlign = 'center';
                    if(document.getElementById('customizaCalendario') != null)
					    this._setText(span, this.showCellLabel ? this.diasDaSemana(col) : null);
                    else
