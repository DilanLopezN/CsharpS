        ...
        <script runat="server">
            ...
            private void adicionaParametros() {
                ...
                if(parms != null && Session["enderecoRelatorioWeb"] != null) {
                    ...
                    Response.Redirect(url + "RelatorioApresentacao/RelatorioPosicaoFinanceira?" + parms + "&enderecoWeb=" + HttpUtility.UrlEncode(Session["enderecoWeb"]+"", System.Text.Encoding.UTF8));
                }
                else
