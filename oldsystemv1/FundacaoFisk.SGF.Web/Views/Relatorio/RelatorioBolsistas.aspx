...
<body>
    <div style="width:100%; height:100%">
       <script runat="server">
           private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("Bolsistas.aspx");
           ...
           private void adicionaParametros()
           {
               ...
               if (parms != null && Session["enderecoRelatorioWeb"] != null)
               {
                   ...
                   Response.Redirect(url + "RelatorioApresentacao/RelatorioBolsistas?" + parms + "&enderecoWeb=" + HttpUtility.UrlEncode(Session["enderecoWeb"] + "", System.Text.Encoding.UTF8));
               }
               else
