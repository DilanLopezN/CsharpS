...
namespace BoletoNet
{
    public interface IBanco
    {
        ...
        /// <summary>
        /// Formata o código cedente
        /// </summary>
        void FormataCodigoCedente(Boleto boleto);
        /// <summary>
        ...
        /// Gera o Trailer do arquivo de remessa
        /// </summary>
        string GerarTrailerRemessa(int numeroRegistro, TipoArquivo tipoArquivo, Cedente cedente, decimal vltitulostotal, int qtdBoletos);
        /// <summary>
