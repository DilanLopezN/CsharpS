...
namespace BoletoNet
{
    ...
    internal class Banco_Uniprime : AbstractBanco, IBanco
    {
        ...
        public override void FormataCodigoBarra(Boleto boleto)
        {
            ...
            {
                 boleto.CodigoBarra.Codigo = string.Format("{0}{1}{2}{3}{4}", Utils.FormatCode(Codigo.ToString(), "0", 3, true), boleto.Moeda,
        ...
        public override void FormataNossoNumero(Boleto boleto)
        {
            ...
            //boleto.NossoNumero = string.Format("{0}/{1}-{2}", Utils.FormatCode(boleto.Carteira, 1), Utils.FormatCode(boleto.Cedente.ContaBancaria.Agencia, 4),
            //    Utils.FormatCode(boleto.DigitoNossoNumero, 6));
        }
        ...
        {
            #region Trecho do manual layout_cobranca_port.pdf do UNIPRIME
            /* 
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                */
                ...
                {
                    switch ((EnumInstrucoes_Uniprime)instrucao.Codigo)
                    {
