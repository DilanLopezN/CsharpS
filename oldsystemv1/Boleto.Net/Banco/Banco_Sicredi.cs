...
namespace BoletoNet
{
    ...
    internal class Banco_Sicredi : AbstractBanco, IBanco
    {
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            ...
            DateTime dataAux = boleto.DataEmissao == null ? DateTime.Now : (DateTime)boleto.DataEmissao;
            ...
            {
                boleto.NossoNumero = dataAux.ToString("yy") + boleto.NossoNumero;
            ...
            {
                boleto.NossoNumero = String.Concat(dataAux.ToString("yy"), boleto.NossoNumero);
                boleto.DigitoNossoNumero += DigNossoNumeroSicredi(boleto);
        ...
        */
        ...
        public string GerarDetalheRemessaCNAB400_A(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediNumericoSemSeparador_, 0083, 010, 2, 0, '0'));                      //083-092 => (chamado 267382 -boleto.ValorDesconto - foi setado 0 pois este desconto não é por antecipação e atualmente não possui calculo para o mesmo)
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediNumericoSemSeparador_, 0093, 004, 0, (boleto.PercMulta * 100), '0'));                  //093-096
