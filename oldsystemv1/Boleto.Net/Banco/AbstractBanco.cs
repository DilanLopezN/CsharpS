...
namespace BoletoNet
{
    public abstract class AbstractBanco
    {
        ...
        /// Gera os registros de Trailer do arquivo de remessa
        /// </summary>
        public virtual string GerarTrailerRemessa(int numeroRegistro, TipoArquivo tipoArquivo, Cedente cedente, decimal vltitulostotal, int qtdBoletos)
        {
            string _trailer = "";
            return _trailer;
        }
        ...
        /// Formata nosso número
        /// </summary>
        public virtual void FormataCodigoCedente(Boleto boleto)
        {
            throw new NotImplementedException("Função não implementada na classe filha. Implemente na classe que está sendo criada.");
        }
        /// <summary>
