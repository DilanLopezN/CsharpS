...
namespace BoletoNet
{
    ...
    public class Boleto
    {
        ...
        private decimal _outrosDescontos2;
        ...
        private DateTime _dataOutrosDescontos2;
        ...
        /// Outros descontos 2
        /// </summary>  
        public decimal OutrosDescontos2
        {
            get { return _outrosDescontos2; }
            set { _outrosDescontos2 = value; }
        }
        ...
        /// <summary> 
        /// Data de Outros Descontos 2
        /// </summary>  
        public DateTime DataOutrosDescontos2
        {
            get { return _dataOutrosDescontos2; }
            set { _dataOutrosDescontos2 = value; }
        }
        ...
        public void FormataCampos()
        {
            try
            {
                ...
                {
                    this.Banco.FormataCodigoCedente(this);
                }
            }
            catch (Exception ex)
            {
