        ...
        private void InstanciaEspecieDocumento(int codigoBanco, string codigoEspecie)
        {
            try
            {
                switch (codigoBanco)
                {
                    ...
                    //237 - DinariPay
                    case 238:
                        _IEspecieDocumento = new EspecieDocumento_DinariPay(codigoEspecie);
                        break;
                    case 356:
                    ...
                    //84 - Uniprime
                    case 84:
                        _IEspecieDocumento = new EspecieDocumento_Uniprime(codigoEspecie);
                        break;
                    default:
        ...
        public static EspeciesDocumento CarregaTodas(int codigoBanco)
        {
            try
            {
                ...
                switch (codigoBanco)
                {
                    ...
                    case 238:
                        return EspecieDocumento_DinariPay.CarregaTodas();
                    case 341:
                    ...
                    case 84:
                        return EspecieDocumento_Uniprime.CarregaTodas();
                    default:
