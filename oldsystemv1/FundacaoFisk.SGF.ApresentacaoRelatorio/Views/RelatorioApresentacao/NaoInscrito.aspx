...
<head runat="server">
    ...
    <style>
        ...
        .lines-dotted-short {
            background: url(../images/forms/lines_dotted_short.gif) no-repeat 0 14px;
            font-size: 0;
            height: 28px;
            line-height: 0;
        }
        ...
        .nav-outer-repeat {
            background: -webkit-gradient(linear,left top,right top,from(#fff),to(#8F9091)) no-repeat;
            background: -moz-linear-gradient(left,#fff,#8F9091);
            filter: progid:DXImageTransform.Microsoft.Gradient(GradientType=1,StartColorStr='#ffffff',EndColorStr='#8F9091');
            background-image: -ms-linear-gradient(top left,#FFF 0%,#8F9091 100%);
            height: 38px;
            min-width: 790px;
        }
        ...
        #nav-left {
            background: -webkit-gradient(linear,left top,right top,from(#900),to(#e2001a)) no-repeat;
            background: -moz-linear-gradient(left,#900,#e2001a);
            filter: progid:DXImageTransform.Microsoft.Gradient(GradientType=1,StartColorStr='#990000',EndColorStr='#e2001a');
            background-image: -ms-linear-gradient(top left,#900 0%,#e2001a 100%);
            float: right;
            position: relative;
            z-index: 0;
            height: 100%;
        ...
        .nav-divider {
            background: url(../images/shared/nav/simple-divider.png) center no-repeat;
            float: left;
            height: 40px;
            width: 15px;
        }
        ...
        #corpo_direita {
            border-image: url(../images/shared/side_shadowright.jpg) 0 20 0 0;
        ...
        #corpo_esquerda {
            border-image: url(../images/shared/side_shadowleft.jpg) 0 0 0 20;
            border-image-width: 20px;
            width: 96%;
            padding-left: 15px;
        }
        ...
        #login-bg {
            background: url(../images/login/fundo_login.jpg) no-repeat center center fixed;
        ...
        #login-bg-vd {
            background: url(../images/login/fundo_login_verde.jpg) no-repeat center center fixed;
            background-size: cover;
            -webkit-background-size: cover;
            -moz-background-size: cover;
            -ms-background-size: cover;
        ...
        .cabecalho_background_esc {
            float: left;
            width: 21%;
            height: 92px;
            background: url(../images/shared/cabecalho_esquerda.png) top center repeat-x;
        }

        .cabecalho_background_cent {
            float: left;
            width: 57.2%;
            height: 92px;
            background: url(../images/shared/cabecalho_cent_completo.png) top center repeat-x;
        }

        .cabecalho_background_cent_right {
            float: left;
            width: 23%;
            height: 92px;
            background: url(../images/shared/cabecalho_cent_completo.png) top center repeat-x;
        ...
        .cabecalho_background_dir {
            float: right;
            width: 21.8%;
            height: 92px;
            background: url(../images/shared/cabecalho_dir_completo.png) top center repeat-x;
        }
        ...
        .cabecalho_background_outer {
            float: left;
        }

        .cabecalho_dir_super {
            background: -webkit-gradient(linear,right top,left top,from(#fff),to(#8F9091)) no-repeat;
            background: -moz-linear-gradient(right,#fff,#8F9091);
            background-image: -ms-linear-gradient(top right,#FFF 0%,#8F9091 100%);
            filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#8F9091',endColorstr='#FFFFFF',GradientType=1);
            height: 56px;
        }

        .cabecalho_back {
            float: left;
            background: url(../images/shared/cabecalho.png) top center repeat-x;
            height: 92px;
            width: 141px;
        }

        .cabecalho_background_inf {
            width: 100%;
            height: 36px;
        }
        ...
        #fsAbertura, #fsEmprestimo, #fsBaixa {
            border: solid;
            border-width: 1px;
            border-color: #f2c87a;
            width: 6cm;
        ...
        #StatusCadBasicosEsc, #EscCadBasicos, #StatusCadBasicosProf, #ProfCadBasicos {
            border: solid;
            border-color: #C7C1C1;
            border-width: 1px;
            width: 350px;
...
<body>
    <div>
        <div id="Parte">
            <script runat="server">
                private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioSaldoFinanceiro.aspx");
                private Microsoft.Practices.ServiceLocation.IServiceLocator locator { get; set; }
                ...
                private void bindRelatorio(string url)
                {
                    ...
                    apresentadorRelatorio.retirarEmailListaEndereco(cd_empresa, cd_cadastro, id_cadastro);
                    TimeStamp.Text = FundacaoFisk.SGF.Utils.Messages.Messages.msgRegExcListaEndereco;
                }
            </script>
        </div>
        <input type="hidden" id="retornoDialogo" value="" />
        <!-- start content-outer ........................................................................................................................START -->
        <div id="content-outer">
            <div id="content">
                <div id="page-heading">
                    <label id="labelTitulos"></label>
                </div>
                <table class="Table" style="width: 100%" id="content-table">
                    <tr>
                        <th rowspan="3" class="sized">
                            <img src="../images/side_shadowleft.jpg" width="20" height="300" alt="" /></th>
                        <th class="topleft"></th>
                        <td id="tbl-border-top">&nbsp;</td>
                        <th class="topright"></th>
                        <th rowspan="3" class="sized">
                            <img src="../images/side_shadowright.jpg"  width="20" height="300" alt="" /></th>
                    </tr>
                    <tr>
                        ...
                        <td style="height: 100%;">
                            ...
                            <div id="content-table-inner">
                                ...
                                <div class="clear"></div>
                                <div class="apresentadorMsg" id="apresentadorMensagemTurma" style="min-height: 15px;">
                                    <table width="100%" class="tituloMensagens">
                                        <tbody>
                                            <tr>
                                                <td style="width: 185px">Lista das mensagens ocorridas        
                                                </td>
                                                <td>
                                                    <div style="line-height: 11px; border-bottom: 1px solid #dbdbdb;">
                                                    </div>
                                                </td>
                                                <td align="right" style="width: 15px">
                                                    <a href="#" onclick="show('tb_mensagem_apresentadorMensagemTurma');" id="listaMensagens">
                                                        <img src="../images/collapse.png" id="imgDtx" style="width: 12px">
                                                        <img src="../images/expand.png" id="imgAtx" style="display: none; width: 12px"></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="mensagensDiv" id="tb_mensagem_apresentadorMensagemTurma">
                                        <table class="mensagens" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 4%; max-width: 25px">
                                                        <img src="../images/avisoMsg.gif">
                                                    </td>
                                                    <td class="tbErro1">
                                                        <div>
                                                            <asp:Label ID="TimeStamp" runat="server" /></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <table width="100%" class="tituloMensagens">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div style="line-height: 11px; border-bottom: 1px solid #dbdbdb; margin-top: -5px;">
                                                        &nbsp;
                                                    </div>
                                                </td>
                                            </tr>
