...
<body>
    <div>
     <script runat="server">
         ...
         private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioInventario.aspx");
         ...
         private void bindRelatorio(string url, ref bool abortou_requisicao)
         {
             ...
             if (renderizarRelatorio)
             {
                 ...
                 string nomeRelatorio = "RptInventario.rdlc";
                 string tituloRel = relatorioDesc;
                 parametrosRelatorio.Add("PPeriodo", "Data Base " + String.Format("{0:dd/MM/yyyy}", pDtaI));
                 ...
                 //List<sp_RptInventario_Result> dtReportData = apresentadorRelatorio.GetSourceRptInventario(cdEscola, pDtaI, tipoRelatorio);
                 DataTable dtReportData = apresentadorRelatorio.GetSourceRptInventario(cdEscola, pDtaI, tipoRelatorio, tipoItem);
                 ...
                 if (dtReportData != null && dtReportData.Rows != null && dtReportData.Rows.Count > 0)
                 {
                     try
                     {
                         ...
                         relatorio.ExibirRelatorioEspecializado(ConfigurationManager.AppSettings["caminhoRelatorio"] + "", FundacaoFisk.SGF.Utils.ReportParameter.RELATORIO_INVENTARIO, sourceHash, parametrosRelatorio);
                     }
                     catch (Exception e)
                     {
                         Console.WriteLine(e);
