...
<body>
    <div>
     <script runat="server">
         ...
         private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioTurmaMatriculaMaterial.aspx");
            ...
            private void bindRelatorio(string url) { 
                ...
                if (parms != null)
                {
                    ...
                    for (int i = 0; i < parametrosGet.Length; i++)
                    {
                        ...
                        if (parametrosHash[0].Equals("@nm_contrato"))
                            nm_contrato = int.Parse(parametrosHash[1]);
                ...
                {
                    var caminhoRelatorio = FundacaoFisk.SGF.Utils.ReportParameter.RELATORIO_TURMA_MATRICULA_MATERIAL;
                    IEnumerable<FundacaoFisk.SGF.Web.Services.Coordenacao.Model.ReportTurmaMatriculaMaterial> materiaisReport = new List<FundacaoFisk.SGF.Web.Services.Coordenacao.Model.ReportTurmaMatriculaMaterial>();
                    ...
                    materiaisReport = apresentadorRelatorio.getRptTurmasMatriculaMaterial(cd_escola, cd_turma, cd_aluno, cd_item, nm_contrato, pDtaI, pDtaF).ToList();
                    sourceHash["DataSetReport"] = materiaisReport;
                    ...
                    parametrosRelatorio.Add(Componentes.Utils.ReportParameter.PARAMETRO_NOME_RELATORIO, "Relatório comparativo Matrícula efetuada x Turma x Material");
                    parametrosRelatorio.Add("DataBase", dataBase);
                    if (materiaisReport != null && materiaisReport.Count() > 0)
