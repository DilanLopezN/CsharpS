...
<body>
    <div style="Width:100%;height:100%;">
        <script runat="server">
            private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioPercentualTerminoEstagio.aspx");
            ...
            private void bindRelatorio(string url){
                ...
                if(parms != null) {
                    ...
                    for(int i = 0; i < parametrosGet.Length; i++) {
                        ...
                        if (parametrosHash[0].Equals("@cdProf"))
                    ...
                    if (renderizarRelatorio)
                    {
                        ...
                        List<FundacaoFisk.SGF.Web.Services.Secretaria.Model.ReportPercentualTerminoEstagio> lista = apresentadorRelatorio.getRptPercentualTerminoEstagio(cd_professor, dt_inicial, dt_final, cd_escola);
                        ...
                        parametrosRelatorio.Add(Componentes.Utils.ReportParameter.PARAMETRO_NOME_RELATORIO, "Relatório de Percentual de Término de Estágio");
                        if (sourceTO != null && sourceTO.ToList<Componentes.GenericModel.TO>().Count > 0)
                        {
                            relatorio.ExibirRelatorioEspecializado(ConfigurationManager.AppSettings["caminhoRelatorio"] + "", FundacaoFisk.SGF.Utils.ReportParameter.RELATORIO_PERCENTUAL_TERMINO_ESTAGIO, sourceTO, parametrosRelatorio);
