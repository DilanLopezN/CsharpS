        ...
        <script runat="server">
            ...
            private void bindRelatorio(string url){
                ...
                if(parms != null) {
                    ...
                    {
                        parametrosRelatorio = new Hashtable();
                        parametrosRelatorio.Add("PCodMovimento", cd_movimento);
                        ...
                        List<Componentes.GenericModel.TO> sourceTO = apresentadorRelatorio.getSourceCopiaEspelhoMovimento(cd_movimento, cdEscola).ToList<Componentes.GenericModel.TO>();

                        Hashtable sourceHash = new Hashtable();
                        sourceHash["DataSetReport"] = sourceTO;

                        if(sourceTO != null && sourceTO.Count > 0) 
                            relatorio.ExibirRelatorioEspecializado(ConfigurationManager.AppSettings["caminhoRelatorio"] + "", FundacaoFisk.SGF.Utils.ReportParameter.RELATORIO_COPIA_ESPELHO_MOVIMENTO, sourceHash, parametrosRelatorio);
                        else {
                            //url = Request.QueryString["enderecoWeb"] != null ? HttpUtility.UrlDecode(Request.QueryString["enderecoWeb"], System.Text.Encoding.UTF8) + "/Erro" : ConfigurationManager.AppSettings["enderecoRetornoErro"];
                            url = FundacaoFisk.SGF.ApresentacaoRelatorio.comum.UrlErro.ObterUrlErroRelatorio(url);
