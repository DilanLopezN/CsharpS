...
<body>
    <div style="Width:100%;height:100%;">
        <script runat="server">
            private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioAulaReposicao.aspx");
            ...
            private void bindRelatorio(string url){
                ...
                if(parms != null) {
                    ...
                    if (renderizarRelatorio)
                    {
                        ...
                        List<sp_RptAulaReposicao_Result> aulaReposicao = apresentadorRelatorio.GetSourceAulaReposicao(cdEscola, dta_ini, dta_fim, cd_turma, cd_funcionario, cd_aluno, id_participacao);
                        List<Componentes.GenericModel.TO> sourceTO = null;

                        //if (aulaReposicao.Count() > 0)
                        // {
                        //     sourceTO = aulaReposicao.ToList<Componentes.GenericModel.TO>();
                        // }

                        parametrosRelatorio.Add("Pdt_inicial", dta_ini);
                        parametrosRelatorio.Add("Pdt_final", dta_fim);
                        ...
                        if (aulaReposicao.Count() > 0)
                        {
                            ...
                            sourceHash["DataReport"] = aulaReposicao; ////LBM: Nome do Dataset do Relatório
                            ...
                            relatorio.ExibirRelatorioEspecializado(ConfigurationManager.AppSettings["caminhoRelatorio"] + "", FundacaoFisk.SGF.Utils.ReportParameter.RELATORIO_AULAREPOSICAO, sourceHash, parametrosRelatorio);
                        }
                        else
                        {
                            //url = Request.QueryString["enderecoWeb"] != null ? HttpUtility.UrlDecode(Request.QueryString["enderecoWeb"], System.Text.Encoding.UTF8) + "/Erro" : ConfigurationManager.AppSettings["enderecoRetornoErro"];
            ...
            private void AlunoSubReportProcessing(object sender, Microsoft.Reporting.WebForms.SubreportProcessingEventArgs e)
            {
                ...
                int cd_atividade = int.Parse(e.Parameters["cd_aula_reposicao"].Values[0].ToString());
                FundacaoFisk.SGF.Web.Services.ApresentadorRelatorio.RelatorioController apresentadorRelatorio = new FundacaoFisk.SGF.Web.Services.ApresentadorRelatorio.RelatorioController();

                IEnumerable<FundacaoFisk.SGF.GenericModel.sp_RptAulaReposicaoAluno_Result> dataTableAulaReposicaoAluno = apresentadorRelatorio.GetSourceAulaReposicaoAluno(cd_atividade, this.cdAluno, this.idParticipacao).ToList();
                e.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("Alunos", dataTableAulaReposicaoAluno));
            }
