...
<%@ Import Namespace="FundacaoFisk.SGF.Web.Services.Financeiro.Business" %>
...
<body>
    <div style="Width:100%;height:100%;">
        <script runat="server">
            private static readonly log4net.ILog logger = log4net.LogManager.GetLogger("RelatorioReciboAgrupado.aspx");
            List<ParcelasReciboAgrupadoUI> parcelasReciboAgrupado = new List<ParcelasReciboAgrupadoUI>();
