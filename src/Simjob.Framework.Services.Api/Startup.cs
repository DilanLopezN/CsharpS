    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<FormOptions>(options =>
            {
                ...
                options.MultipartBodyLengthLimit = long.MaxValue; // Define o tamanho m�ximo permitido para o corpo da requisi��o (multipart/form-data)
