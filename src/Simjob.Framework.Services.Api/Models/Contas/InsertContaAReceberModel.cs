...
{
    public class InsertContaAReceberModel
    {
        [Required]
        ...
        public int? cd_plano_conta_tit { get; set; }
        [Required]
        ...
        public List<PlanoTituloContaReceberModel>? plano_titulo { get; set; }

    }
    public class PlanoTituloContaReceberModel
    {
