...
{
    public class InsertEscolaModel
    {
        ...
        public PessoaEscola pessoa { get; set; } = new PessoaEscola();
        public FichasaudeEscola fichaSaude { get; set; } = new FichasaudeEscola();
        ...
        public class PessoaEscola
        {
            ...
            public EnderecoEscola endereco { get; set; } = new EnderecoEscola();
