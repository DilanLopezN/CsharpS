    ...
    public async Task<IActionResult> GetById(int cd_contrato)
    {
      ...
      if (source != null && source.Active != null && source.Active == true)
      {
        ...
        if (aditamentos_temp.success && aditamentos_temp.data != null && aditamentos_temp.data.Any())
        {
          ...
          var titulos_dos_aditamentos = await SQLServerService.GetList("vi_contrato_titulos", cd_aditamentos_list, "cd_origem", null, source);
      ...
      if (source != null && source.Active != null && source.Active == true)
      {
        ...
        if (!model.IsNullOrEmpty())
        {
          ...
          foreach (var ad in model)
          {
            ...
            {
              var sequencia = aditamentos_contrato.success && aditamentos_contrato.data != null ? aditamentos_contrato.data.Count + 1 : 1;
